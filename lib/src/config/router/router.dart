...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(page: StartRoute.page, path: '/get-started'),
        AutoRoute(page: SignInRoute.page, path: '/get-started/sign_in'),
        AutoRoute(page: SignUpRoute.page, path: '/get-started/sign_up'),
